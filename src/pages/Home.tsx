export default function Home() {
  return (
    <section className="mx-auto max-w-xl text-center">
      ...
      <p className="text-gray-600 mb-8">Version bêta minimale pour tester l'essentiel.</p>
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        >
          Je suis parent (se connecter avec Spotify)
        </a>
        <a
          href="/child/login"
          className="inline-block px-5 py-3 rounded-lg border border-gray-300 text-gray-900 font-medium"
        >
          Espace enfant
        </a>
      </div>
